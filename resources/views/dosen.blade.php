            ...
            <div class="table-responsive mt-5">
                ...
                <form method="GET">
                    <div class="input-group mb-3">
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Cari Nama dosen">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr>
                            ...
                            <td>{{ $dsn->email }}</td>
                            <td>
                                <a href="{{ url('/dosen/' . $dsn->id . '/detail') }}" class="btn btn-sm btn-info">view</a>
